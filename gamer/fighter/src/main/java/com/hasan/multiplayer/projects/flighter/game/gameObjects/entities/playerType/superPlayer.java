package com.hasan.multiplayer.projects.flighter.game.gameObjects.entities.playerType;
...
public abstract class superPlayer extends gameObject{
    ...
    protected superPlayer(gamePanel gp) {
        super(gp, com.hasan.multiplayer.projects.flighter.game.gameObjects.enums.gameObjectType.player);
    }
